...
- **Imagens:** **SEMPRE** use o componente `Image` do Next.js (`next/image`) para renderização de imagens.
- **NUNCA** utilize a tag `<img>` nativa do HTML diretamente. Isso garante otimização automática, lazy loading, melhor performance, responsividade e conformidade com as boas práticas do Next.js.
